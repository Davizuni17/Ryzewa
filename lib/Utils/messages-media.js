        ...
        for (const { hostname } of hosts) {
            ...
            try {
                ...
                if (result?.url || result?.directPath) {
                    ...
                    // Some endpoints (e.g. /mms/sticker-pack) don't return handle.
                    // Fallback: use fileEncSha256B64 as synthetic handle
                    const effectiveHandle = result.handle || fileEncSha256B64
                    console.log('[upload] handle:', result.handle || 'NONE', '-> using:', effectiveHandle)
                    urls = {
                        mediaUrl: result.url,

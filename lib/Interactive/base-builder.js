...
/**
 * Clase base de todos los builders interactivos.
 * Aporta los campos comunes: título, subtítulo, cuerpo, pie,
 * contextInfo y payload extra a mezclar en el mensaje final.
 */
class BaseBuilder {
    constructor() {
        this._title = ''
